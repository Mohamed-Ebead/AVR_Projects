...
void LCD_vidInitialize(void){
	...
	/****************  LCD Configuration  *****************/
			  ...
			  DIO_SetPinDirection (Ctrl_PORT, VDD , OUTPUT);

			  //  RS >> D1
			  DIO_SetPinDirection (Ctrl_PORT, RS, OUTPUT);

			  //  R/W >> D2
			  DIO_SetPinDirection (Ctrl_PORT, RW, OUTPUT);

			  //  Enable >> D3
			   DIO_SetPinDirection (Ctrl_PORT, E, OUTPUT);
